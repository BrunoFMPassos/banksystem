...
public class RelatorioPDFExtrato implements Serializable {
    ...
    public byte[] criarRelatorio(List<Movimentacao> lista, Conta conta) throws Exception{
        ...
        rellnStream = RelatorioPDF.class.getClassLoader().getResource("relatorios/Extrato.jasper").openStream();
